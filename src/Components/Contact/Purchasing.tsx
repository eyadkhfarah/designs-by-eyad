...
import { IconQrcode, IconExternalLink, IconCopy } from "@tabler/icons-react";
...
export default function PurchasingComponent() {
  return (
        ...
        >
          ...
          <div className="relative z-10 flex flex-col gap-6">
            <div className="flex justify-between items-start">
              ...
              <IconQrcode className="text-2xl text-primary" />
            </div>
